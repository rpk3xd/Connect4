        ...
        while(true){
            ...
            if(game.turn){
                ...
                if(columnP < 0 || columnP > 6){
                    ...
                    isWon = game.insert(game.getGrid(), columnP, game.getCol());
                    game.turns++;
                }
            }else{
                ...
                if(game.turns == 1 || game.turns == 0){
                    ...
                    columnC = game.generateMove(game.getGrid(), game.getCol());
                }
                isWon = game.insert(game.getGrid(), columnC, game.getCol());
                game.turns++;
            }
            if(isWon) break;
